  ...
  return (
    <div>
      ...
      >
        ...
        <div className="mx-6 py-10 text-center md:text-left flex justify-center sm:block">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <p className="mb-4">
                <a
                  href="/resources/how-to-get-3-new-seller-listings-in-90-days-with-youtube-ads.2a61f05611ac40538bceb9f40d9e9c46"
                  className="text-black dark:text-neutral-200"
                >
                  How To Get 3 New Listings On Autopilot Every 90 Days With
                  Youtube Ads + Detailed Examples
                </a>
              </p>
              <p className="mb-4">
                <a
                  href="/resources/7-figure-agents-facebook-ad-bible.55b6b4c5b80449a2a269b960a6d88355"
                  className="text-black dark:text-neutral-200"
                >
                  The 7 Figures Agent's Facebook Ad Bible + 10 Copy Paste Ads
                </a>
              </p>
              <p className="mb-4">
                <a
