    ...
    <section className="px-6 xl:px-0">
      <div className="mt-52 mx-auto container">
        <div className="flex flex-col lg:items-center justify-center w-full">
          <h1 className="font-black text-center text-white text-6xl md:text-7xl">
              ...
              <div className="flex flex-wrap mb-12 justify-between sm:justify-center -mx-6">
                <div className="w-full xl:w-1/3 lg:w-1/3 md:w-1/2 sm:w-1/2 mb-4 px-6">
                  <div className="py-5 px-4 bg-white border border-gray-200shadow rounded-lg text-left">
                    <h4 className="text-4xl text-center text-indigo-700 font-semibold pb-8">
                      Package 1
                    </h4>
                ...
                <div className="w-full xl:w-1/3 lg:w-1/3 md:w-1/2 sm:w-1/2 mb-4 px-6">
                  <div className="py-5 px-4 bg-indigo-700 border border-gray-200 shadow rounded-lg text-left">
                    <h4 className="text-4xl text-white font-semibold pb-8 text-center">
                      Package 2
                    </h4>
                    <ul className="flex flex-col mb-6">
                      <li className="flex items-center mb-2.5">
                ...
                <div className="w-full xl:w-1/3 lg:w-1/3 md:w-1/2 sm:w-1/2 mb-4 px-6">
                  <div className="py-5 px-4 bg-white border border-gray-200shadow rounded-lg text-left">
                    <h4 className="text-4xl text-indigo-700 font-semibold pb-8 text-center">
                    ...
                    <ul className="flex flex-col mb-6">
                      <li className="flex items-center mb-2.5">
                        <img
                          ...
                          alt="check-mark"
                        />
                        <p className="text-gray-800 text-base  font-black">
                      ...
                      <li className="flex items-center mb-2.5">
                        ...
                        />
                        <p className="text-gray-800 text-base font-normal">
                          Total Control Of Offer Leads And Targeting.
                        </p>
                      </li>
                      <li className="flex items-center mb-2.5">
                        <img
                      ...
                      <li className="flex items-center mb-2.5">
                        ...
                        />
                        <p className="text-gray-800 text-base font-normal">
                          Month 2 consultation calls and campaign optimization{" "}
                        </p>
                      </li>
                    </ul>
