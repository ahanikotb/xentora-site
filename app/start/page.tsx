...
const copy = new Map([
  [
    {
      preheadline:
        "<span class='text-black'>For Realtors looking to beat the market.  <span/>",
      headline:
      ...
      subtitle:
        "<span class='text-red-500'>Enter Your Info Below And We'll Send You A Breakdown Video Of all her lead generation and sales process. 👇 </span>",
